...
EOF
 ...
 # Install Moodle 3.2.1
  ...
  #config for connect remote DB
    sudo php /var/www/html/moodle/admin/cli/install.php --chmod=2777 --lang=uk --dbtype=mariadb --wwwroot=http://192.168.56.112/moodle --dataroot=/var/www/moodledata --dbhost=192.168.56.110 --dbname=dbtask2 --dbuser=${DB_User} --dbpass=${DB_Pass} --fullname=Moodle --shortname=moodle --summary=Moodle --adminpass=Admin1 --non-interactive --agree-license
